...
def aggregate_data(job_title=None, education_level=None):
    ...
    field_of_study_counts = aggregate_query(FieldOfStudy, FieldOfStudy.field_of_study, job_title)

    if education_level:
        field_of_study_counts = field_of_study_counts[field_of_study_counts['education_level'] == education_level]
